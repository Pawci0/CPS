...
{
    public class DetailsViewModel1 : BindableObject, IPageViewModel
    {
        ...
        public PageEnum NameOfPage => PageEnum.DetailsPage1;
        ...
        public ChartDetailsEnum ChartDetailName
        {
            ...
            set
            {
                ...
                if (_chartDetailsEnum == ChartDetailsEnum.Sinus)
                {
                    Amplitude = 10;
                    Period = 6;
                    BeginsAt = 0;
                ...
                else if (_chartDetailsEnum == ChartDetailsEnum.SinusOneSideStraightened)
                {
                    Amplitude = 10;
                    Period = 6;
                    BeginsAt = 0;
                ...
                else if (_chartDetailsEnum == ChartDetailsEnum.SinusBothSideStraightened)
                {
                    Amplitude = 10;
                    Period = 6;
                    BeginsAt = 0;
        ...
        public void OnGenerateChart()
        {
            ...
            if (ChartDetailName == ChartDetailsEnum.Sinus)
                Signal = SignalGenerator.Sinus(Amplitude, Period, BeginsAt, Duration, SamplingFrequency);
            else if (ChartDetailName == ChartDetailsEnum.SinusOneSideStraightened)
                Signal = SignalGenerator.SinusOneSideStraightened(Amplitude, Period, BeginsAt, Duration, SamplingFrequency);
            else if (ChartDetailName == ChartDetailsEnum.SinusBothSideStraightened)
                Signal = SignalGenerator.SinusBothSideStraightened(Amplitude, Period, BeginsAt, Duration, SamplingFrequency);

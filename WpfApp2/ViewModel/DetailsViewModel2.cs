...
{
    public class DetailsViewModel2 : BindableObject, IPageViewModel
    {
        ...
        public ChartDetailsEnum ChartDetailName
        {
            ...
            set
            {
                ...
                if (_chartDetailsEnum == ChartDetailsEnum.Rectangular)
                {
                    Amplitude = 10;
                    Period = 6;
                    BeginsAt = 0;
                ...
                else if (_chartDetailsEnum == ChartDetailsEnum.RectangularSymmetrical)
                {
                    Amplitude = 10;
                    Period = 6;
                    BeginsAt = 0;
                ...
                else if (_chartDetailsEnum == ChartDetailsEnum.Triangular)
                {
                    Amplitude = 10;
                    Period = 6;
                    BeginsAt = 0;
        ...
        public void OnGenerateChart()
        {
            ...
            if (ChartDetailName == ChartDetailsEnum.Rectangular)
                Signal = SignalGenerator.Rectangular(Amplitude, Period, BeginsAt, Duration, FillFactor, SamplingFrequency);
            else if (ChartDetailName == ChartDetailsEnum.RectangularSymmetrical)
                Signal = SignalGenerator.RectangularSymmetrical(Amplitude, Period, BeginsAt, Duration, FillFactor, SamplingFrequency);
            else if (ChartDetailName == ChartDetailsEnum.Triangular)
                Signal = SignalGenerator.Triangular(Amplitude, Period, BeginsAt, Duration, FillFactor, SamplingFrequency);

...
{
    public class DetailsViewModel4 : BindableObject, IPageViewModel
    {
        ...
        public PageEnum NameOfPage => PageEnum.DetailsPage4;
        ...
        public void OnGenerateChart()
        {
            ...
            Signal = SignalGenerator.ImpulsiveNoise(Amplitude, BeginsAt, Duration, Probability, SamplingFrequency);
